    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<Animal>()
        .HasData(
            ...
            new Animal { AnimalId = 2, Name = "Bob", Species = "Panda", Age = 8, Gender = "Unknown", Bio = "Bob is very friendly but has a strange coat for a dog and is unusually large. Big fan of bamboo though." },
            ...
            new Animal { AnimalId = 4, Name = "Diana", Species = "Capybara", Age = 64, Gender = "Female", Bio = "Wanted by several international policing agencies for arson. Do not allow near matches unsupervised. Likes Cheese Puffs." },
            ...
            new Animal { AnimalId = 6, Name = "Turbo", Species = "Narwhal", Age = 32, Gender = "Male", Bio = "Pure speed. Ka-chow." },
